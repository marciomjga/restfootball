...
import de.planerio.developertest.controller.commons.exceptions.ApiError;
import de.planerio.developertest.controller.commons.exceptions.ApiFieldValidationError;
...
public class RestExceptionHandler {
  ...
  @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
  public ApiFieldValidationError handleMethodArgumentNotValidException(
      final MethodArgumentNotValidException e) {

    final ApiFieldValidationError validationError =
        new ApiFieldValidationError(
            HttpStatus.UNPROCESSABLE_ENTITY.value(), "One or more fields have an error");
